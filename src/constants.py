...
INSTALLER_ROP_START  = REGION_CONST(0x0945ff1c, TODO, 0x0944ff0c)
INSTALLER_ROP_END    = INSTALLER_ROP_START + 0x100
INSTALLER_ROP_SAFE   = INSTALLER_ROP_END + 0x400
PERSISTENT_ROP_START = REGION_CONST(0x0945fdf0+0x11c, TODO, 0x0944ff14) # 0x0014bcd4
PERSISTENT_ROP_END   = PERSISTENT_ROP_START + 0x400
PERSISTENT_ROP_SAFE  = PERSISTENT_ROP_END + 0x400
